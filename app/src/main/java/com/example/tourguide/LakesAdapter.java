...
public class LakesAdapter extends RecyclerView.Adapter<LakesAdapter.MyViewHolder>{
    private Context context;
    private Activity activity;
    private ArrayList service_id, name, category, service_type, provider_name, phone, email, location;
    public LakesAdapter(Context context, Activity activity, ArrayList service_id, ArrayList name, ArrayList category,
    ...
    @NonNull
    @Override
    public LakesAdapter.MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        LayoutInflater inflater = LayoutInflater.from(context);
        View view = inflater.inflate(R.layout.lakes, parent, false);
    ...
    class MyViewHolder extends RecyclerView.ViewHolder {
        ...
        MyViewHolder(@NonNull View itemView) {
            ...
            mainLayout = itemView.findViewById(R.id.lakeLayout);
